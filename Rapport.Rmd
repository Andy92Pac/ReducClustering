...
```{r,eval=FALSE, message=FALSE, warning=FALSE, include=TRUE,results='hide'}
EM.mfeat <- mixmodCluster(data.frame(pca.mfeat$ind), 2:10,dataType = "quantitative",criterion = "BIC",strategy = new("Strategy",algo = "EM"))
```
...
```{r,eval=FALSE, message=FALSE, warning=FALSE, include=TRUE,results='hide'}
EM.mnist <- mixmodCluster(data.frame(pca.mnist$ind), 2:10,dataType = "quantitative",criterion = "BIC",strategy = new("Strategy",algo = "EM"))
```
...
## 11. Cluspa
>>>>>>> 37dfd9ac86e12d8b54ff2a6c0bed09b629f4d1e2
