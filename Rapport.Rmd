...
```{r,eval=FALSE, message=FALSE, warning=FALSE, include=TRUE,results='hide'}
EM.jaffe <- mixmodCluster(data.frame(pca.jaffe$ind), 2:20,dataType = "quantitative",criterion = "BIC",strategy = new("Strategy",algo = "EM"))
```
...
```{r,eval=FALSE, message=FALSE, warning=FALSE, include=TRUE,results='hide'}
MclustDRpartition.jaffe <- MclustDR.jaffe
